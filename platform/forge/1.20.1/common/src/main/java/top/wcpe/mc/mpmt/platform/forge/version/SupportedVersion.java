...
public enum SupportedVersion {
    ...
    public static SupportedVersion match(String mcVersion) {
        if (mcVersion == null) {
            throw new IllegalStateException("不支持的 Minecraft 版本（缺少 Forge vX_Y 适配）：null");
        }
        ...
        throw new IllegalStateException("不支持的 Minecraft 版本（缺少 Forge vX_Y 适配）：" + mcVersion);
    }
}
