...
/** Fabric 服务端闭环持有者：统一复用唯一的封禁表、会话表、网络特性与封禁服务。 */
public final class FabricServerServices {

    private final SessionRegistry sessionRegistry;
    private final ServerNetworkFeature networkFeature;
    private final BanService banService;

    private FabricServerServices(
    ...
    /** 从运行时端口装配并初始化服务端闭环。 */
    public static FabricServerServices install(MpmtRuntime runtime) {
        ...
        service.initialize();
        return new FabricServerServices(sessions, network, service);
    }
