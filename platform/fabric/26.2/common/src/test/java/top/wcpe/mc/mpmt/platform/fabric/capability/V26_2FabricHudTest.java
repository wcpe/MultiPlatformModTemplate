...
/**
 * Fabric 26.2 客户端 HUD 实现（L4 适配器）：快照暴露、清空、按 kind 渲染与 Toast 投递。
 *
 * <p>渲染经产品自身的包注册路径进入，断言的是快照内容与文本去向。
 */
class V26_2FabricHudTest {
    ...
    @Test
    @DisplayName("TOAST 经类型化 API 进入 Toast 队列，且不落到标题位")
    void Toast渲染() {
        Fixture fixture = new Fixture();
    ...
    private static final class Fixture {
        ...
        private final ClientTestSupport.RecordingHud hudGui;
        private final V26_2FabricHud hud = new V26_2FabricHud();
        ...
        ClientTestSupport.RecordingHud hudGui() {
            return hudGui;
        }
