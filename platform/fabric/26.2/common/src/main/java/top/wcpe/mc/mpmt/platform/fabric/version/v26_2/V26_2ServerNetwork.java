...
/** Fabric 26.2 服务端类型化载荷裸字节适配器。 */
public final class V26_2ServerNetwork implements FabricServerNetwork {

    private static final int MAX_PAYLOAD = 1048576;

    private final V26_2PayloadRegistration registration;

    V26_2ServerNetwork(V26_2PayloadRegistration registration) {
