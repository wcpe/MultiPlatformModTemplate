...
- [第三期 · 平台规模化与对外上手](p3-platform-scaling-and-onboarding.md)（FR-16 已交付@v0.3.0；FR-17/FR-18 待 `v0.3.0` 的 GitHub Release 完成；基线 `v0.2.0`）
- [FR-16 · MC 26.2 版本适配（冻结）](fr-26_2-adapter.md)（T1–T5 已完成：仅 Paper/Fabric/Forge，Folia 无 26.2；三车道同轮 REALSERVER262 与根门已通过，ADR-0023 定义为最终自动化验收）
