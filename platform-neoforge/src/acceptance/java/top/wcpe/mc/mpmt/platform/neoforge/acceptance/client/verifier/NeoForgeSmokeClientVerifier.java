 ...
 * 验证"服务端驱动 ↔ NeoForge 客户端联调 + 跨端 HUD"链路本身（FR-27）。经 {@code ServiceLoader} 被伴侣发现。
 *
 * <p><b>仅客户端</b>（{@link OnlyIn}(Dist.CLIENT)）：读 {@link NeoForgeHudRenderer#lastRendered()} 客户端快照。
 */
@OnlyIn(Dist.CLIENT)
public final class NeoForgeSmokeClientVerifier implements ClientVerifier {

    /** 期望收到的 HUD 文本（须与 NeoForgeSmokeServerScenario 发的一致，FR-27）。 */
